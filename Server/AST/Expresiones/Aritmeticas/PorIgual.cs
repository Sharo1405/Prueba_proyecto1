...
namespace Server.AST.Expresiones.Aritmeticas
{
    class PorIgual: Expresion
    {
        ...
        public PorIgual(int linea, int columna, Expresion expresion2, String id)
        {
        ...
        public PorIgual(int linea, int columna, Expresion expresion1, Expresion expresion2)
        {
            this.id = "";
        ...
        public PorIgual(int linea, int columna, Expresion expresion1, Expresion expresion2, String id)
        {
            this.expresion1 = expresion1;
            this.expresion2 = expresion2;
            this.linea = linea;
