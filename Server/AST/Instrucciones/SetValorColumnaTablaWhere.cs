    ...
    class SetValorColumnaTablaWhere : Instruccion
    {
        ...
        public object ejecutar(Entorno entorno, ErrorImpresion listas, Administrador management)
        {
            ...
            if (col.tipo == tipoDato.id)
            {
                ...
                CreateType typeUser = (CreateType)col.valorColumna.ElementAt(posicionColumna);                
                    contador2 = 0;
            ...
            else if (col.tipo == tipoDato.list || col.tipo == tipoDato.set)
            {
                ...
                Lista item = (Lista)col.valorColumna.ElementAt(posicionColumna);
            ...
            else
            {
                ...
                else
                {
                    if (col.tipo == tipoValorParaAsignar)
                    {
                        ...
                        col.valorColumna.RemoveAt(posicionColumna);
                        col.valorColumna.Insert(posicionColumna, valorParaAsignar);
                    }
                    else
                    {
                        listas.errores.AddLast(new NodoError(this.linea, this.columna, NodoError.tipoError.Semantico,
