...
namespace Server.AST.Expresiones.Aritmeticas
{
    class Incremento: Expresion
    {
        ...
        public Incremento(Expresion id, int linea, int columna)
        {
            this.idExp = id;
            this.linea = linea;
        ...
        public Incremento(String id, Expresion idex, int linea, int columna)
        {
            this.id = id;
            this.idExp = idex;
            this.linea = linea;
        ...
        public object getValue(Entorno entorno, ErrorImpresion listas, Administrador management)
        {
            ...
            { }
            listas.errores.AddLast(new NodoError(linea, columna, 
                NodoError.tipoError.Semantico, "No se puede realizar el Incremento ++"));
            return tipoDato.errorSemantico;
        }
    }
}
